...
- Main process buffers capture data for observation building and reports `capture:status` to the UI.

## Operator Visibility

- The capture panel shows live thumbnails for the latest camera/screen frames.
